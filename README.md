...
Data and context are stored using [Kloset](http://www.plakar.io/posts/2025-04-29/kloset-the-immutable-data-store/), an open-source, immutable data store that enables the implementation of advanced data protection scenarios.
...
- **Secure**: Provide audited end-to-end encryption for data and metadata. See our latest [crypto audit report](http://www.plakar.io/docs/audits/).
- **Reliable**: Backups are stored in Kloset, an open-source immutable data store. Learn more about [Kloset](http://www.plakar.io/posts/2025-04-29/kloset-the-immutable-data-store/).
